...
<body id="page-top" class="index">
    ...
    <section class="success" id="projects">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p>Due to my diverse interests I have many on-going projects in various stages of completion and seriousness. The list below mentions some of the larger ones.</p>
                    <ul class="no_points">
                        <li>
                        ...
                        <li>
                            ...
                            <p>OKCupid contains thousands of user-generated questions used for matching persons. Since these answers are public they can be gathered automatically. Since late 2014 we have been scraping the data form OKCupid and currently have a database of some 70,000 unique users and their answers to approximately 2000 questions as well as demographic informaiton. Currently unpublished.</p>
                        </li>
                        <li>
