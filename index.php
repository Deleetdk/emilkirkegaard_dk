...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 special_links">
                    <p>I am a 26 year old polymath wannabe(?), see very long list of interests <a href="#interests">below</a>. I am mostly self-taught in various subjects and currently a master's student in linguistics at Aarhus University, Denmark (<a href="http://lyddansk.dk/?p=226">my bachelor thesis</a> concerned spelling reform with a focus on a proposal for Danish I developed). Basically, I do it mostly for the money (<a href="https://en.wikipedia.org/wiki/Student_loans_in_Denmark">the Danish state will pay you to study AND education is free</a>) and spend my free time studying whatever interests me.</p>
    ...
    <section id="interests" class="alt">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Interests</h2>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                        <p>My interests are very broad, but for the time I am mainly focused on psychology, sociology, statistics and  programming. A non-exhaustive list of areas of interest can be seen below. I have somewhat ranked them by current interest level.</p>
                </div>
                <div class="col-lg-8 col-lg-offset-2 text-left">
                    <ul>
                        ...
                        <ul>
                            ...
                            <li>Civil rights</li>
                            <li>Drug policy</li>
                            <li>Intellectual 'property'/monopolies (copyright, patents, trademarks)</li>
                            <li>Seasteading</li>
                        </ul>
                        <li>Philosophy</li>
                        <ul>
                            ...
                            <li>Metaethics and ethics</li>
                            <li>Transhumanism</li>
                            <li>Metaphysics of logic</li>
                        </ul>
                    </ul>
                </div>
            </div>
    ...
    <section class="success" id="projects">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p>Due to my diverse interests I have many on-going projects in various stages of completation and seriousness. The list below mentions some of the larger ones.</p>
                    <ul class="no_points">
                        <li>
                            <h3><a href="http://openpsych.net/">OpenPsych</a></h3>
                            <p>An open acccess, free-to-publish, data-sharing, open peer review metajournal right now focusing on differential psychology and behavioral genetics but we will expand.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>OKCupid contains thousands of user-generated questions used for matching persons. Since these answers are public they can be gathered automatically. Since late 2014 we have been scraping the data form OKCupid and currently have a database of some 70,000 unique users and their answers to approximately 2000 questions as well as demogaphic informaiton. Currently unpublished.</p>
                        </li>
                        <li>
    ...
    <section class="alt" id="publications">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Publications</h2>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p>Since there are high time-costs, and sometimes monetary as well, associated with publishing in pre-publication review journals and in many cases <a href="https://en.wikipedia.org/wiki/Scholarly_peer_review#Criticism_of_peer_review">a relatively small benefit</a> aside from reputational gain, I often publish in outlets with no prior review.</p>
                ...
                <?php
                $result = array_map('str_getcsv', file('publications.csv'));
                #make table
                echo "<table id='publicationsTable' class='tablesorter'>\n"; // start a table tag in the HTML
                echo "<thead><tr><th class='sortableHeader'>Title</th>
                                 <th class='sortableHeader'>Author(s)</th>
                                 <th class='sortableHeader'>Type</th>
                                 <th class='sortableHeader'>Outlet</th>
                                 <th class='sortableHeader'>Pre-publication review</th>
                                 <th class='sortableHeader'>Date</th>
                                 <th class='sortableHeader'>Sole author</th>
                                 <th class='sortableHeader'>First author</th>
                                 <th class='sortableHeader'>Last author</th></tr></thead>\n";
                echo "<tbody>\n";
                ...
                $(document).ready(function()
                    {
                        $("#publicationsTable").tablesorter(  {sortList: [[5,1]]}  );
                    }
                );
                </script>
                </div>
